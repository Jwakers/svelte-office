...
export default function Carousel({ images }: { images: { src: string; altText: string }[] }) {
  ...
  return (
    <div className="group relative animate-fadeIn border-r border-black">
      <Swiper
      ...
      {images.length > 1 ? (
        <div className="absolute bottom-0 right-0 z-10 flex content-end justify-between border border-b-0 border-r-0 border-black transition-opacity md:opacity-0 md:group-hover:opacity-100">
